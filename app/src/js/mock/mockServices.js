...
angular.module('weatherAppDev', ['weatherApp', 'ngMockE2E'])
    .run(function ($httpBackend) {
       ...
       $httpBackend.whenJSONP('http://api.openweathermap.org/data/2.5/forecast%2Fdaily?callback=JSON_CALLBACK&cnt=7&mode=json&q=Oslo&units=metric').respond(function (method, url, data, headers) {
